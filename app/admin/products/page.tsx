...
const ProductsPage = () => {
    ...
    const onPageChange = ({selected}: {selected : number}) => router.push(`/admin/products?page=${selected + 1}`)
                    ...
                    <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                {
                                    isLoading
                                    ? <div className="p-5"><LoadingBox /></div>
                                    :   data?.products.length > 0 ? <table className="min-w-full divide-y divide-gray-300">
                                                                ...
                                                                : <div className="p-5"><EmptyList title="در حال حاضر محصولی برای نمایش وجود ندارد." description="در حال حاضر محصول وجود ندارد شما می توانید محصول مورد نظر خود را اضافه کنید." /></div>
                                }
